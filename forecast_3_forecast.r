...
#calculate forecast performance as R2 of observed ~ forecast linear regression model
...
#Find maximum: project_used = -4 and region_used = -1
r2_max = forecast_hyb_summ_yr %>%
  filter(r2 == max(r2, na.rm = T))
#Find top ten: mostly when project_used is not -1 and region_used is 1
...
#Compare observed vs forecasted for the best mixed forecast method
